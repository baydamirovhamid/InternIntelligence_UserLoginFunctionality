...
{
    public class UsernameAuthenticationStrategyService : IAuthenticationStrategyService
    {
        ...
        public UsernameAuthenticationStrategyService(IUserService userService, UserManager<AppUser> userManager)
        {
